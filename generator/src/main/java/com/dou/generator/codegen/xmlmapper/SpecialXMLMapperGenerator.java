package com.dou.generator.codegen.xmlmapper;

import com.dou.generator.codegen.xmlmapper.elements.SpecialSelectSelectiveElementGenerator;
 ...
 */
public class SpecialXMLMapperGenerator extends AbstractXmlGenerator {

    public SpecialXMLMapperGenerator() {
        super();
    }
    ...
    protected void addSelectSelectiveElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SpecialSelectSelectiveElementGenerator();
