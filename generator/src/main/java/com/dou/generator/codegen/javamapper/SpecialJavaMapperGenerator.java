package com.dou.generator.codegen.javamapper;
...
public class SpecialJavaMapperGenerator extends AbstractJavaClientGenerator {


    public SpecialJavaMapperGenerator() {
        super(true);
    }

    public SpecialJavaMapperGenerator(boolean requiresMatchedXMLGenerator) {
